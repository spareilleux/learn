...
| Jev as an advisory hexavalent annotator | experimenting | inconclusive | Pre-register a U definition with a companion clause ("unless other evidence leans one way, then P or D") and re-run; separately, test the C sentence on real Demerzel belief files before proposing it for logic/hexavalent-logic.md. | Advisory only: a Jev value is one input to Demerzel's deterministic confidence ladder, never a verdict; C still escalates to a human. |
...
| Jev as an advisory hexavalent annotator | Step 1 (Demerzel definitions, 120 calls, $0.0027 computed): 41/58 both orders, 0 false T, 7/10 absences read as F/D in both orders, 4/10 conflicts collapsed to F: INCONCLUSIVE. Step 2 (explicit U and C criteria, 120 calls, $0.0030): 46/58 and 44/58, 0 false T, conflicts 10/10, absences 4 and 5/10, but P fell into U 6/10: NOT_FIXED. Synthetic, English, agent-authored corpus; costs are reported usage times list price, not bills. | `../typesafe-ai-system-one/demerzel-hexavalent-PREREG.md`, `../typesafe-ai-system-one/demerzel-hexavalent-step2-PREREG.md`, `../typesafe-ai-system-one/demerzel-hexavalent-corpus.json`, `../typesafe-ai-system-one/evidence/demerzel-hexavalent-live.json`, `../typesafe-ai-system-one/evidence/demerzel-hexavalent-step2-live.json` | 2026-10-09 |
