// Makes the outputs of tsc, Vite, Vitest, oxlint and create-vite comparable between machines: node normalize.mjs < raw.txt > out.txt
...
//   an HMR timestamp TIMESTAMP, and inline source maps are shortened
// - stack frames ("    at …") are dropped, and the process ID of a warning becomes PID
import { readFileSync } from 'node:fs';

const course = 'react-vite';
