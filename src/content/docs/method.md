...
5. **Bilingual.** English is the reference language; the French version follows under `/fr/`.

## Adding a course

1. Create `src/content/docs/<topic>/` (English) and `src/content/docs/fr/<topic>/` (French), with identical file names.
