...
- [TypeScript handbook — JSX](https://www.typescriptlang.org/docs/handbook/jsx.html) and [`@types/react`](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/react)
