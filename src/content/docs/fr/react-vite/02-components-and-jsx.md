...
L'avertissement n'apparaît qu'en développement, quand la liste est rendue, et la liste s'affiche correctement. oxlint, avec les règles du `.oxlintrc.json` du modèle, le trouve sans rien exécuter :
