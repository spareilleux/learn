...
Guitar Alchemist range chaque voicing de guitare qu'il connaît sous forme d'une liste de 124 nombres. Ce prototype en transforme 30 000 en un nuage de points qu'on peut faire tourner, pointer et écouter, puis mesure quelle part de l'espace réel l'image montre. La réponse courte : une bonne carte, et un mauvais guide du voisinage.
...
<LazyDemo
	...
	note="Rien n'est téléchargé avant le clic. Faites glisser pour tourner, survolez pour nommer une voicing, cliquez pour la sélectionner et l'entendre. Page complète :"
/>
