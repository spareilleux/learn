...
- TRELLIS.2 demande ici environ 23 Go de RAM libre, et l'amont demande 24 Go de VRAM ; il n'a pas tourné. Les deux objets sont remodélisés avec `bpy` à la place : le [journal Blender](../../blender/journal/#2026-09-17--des-modèles-générés-dans-comfyui-nettoyés-dans-blender) raconte ce côté de l'histoire.
...
- Si `LoadImage` liste les fichiers `.exr` sous Linux et macOS, et si l'`EXRLoader` de three.js lit dans un navigateur l'EXR non compressé de ComfyUI.
