...
- Sous Windows, `LoadImage` ne liste pas les fichiers `.exr` : le module `mimetypes` de Python n'a pas de type pour eux, donc [le filtre](https://github.com/Comfy-Org/ComfyUI/blob/ee71d5c4993f29086b27fde1629a945ae48425bf/folder_paths.py#L229-L253) les écarte. Linux et macOS dépendent de la base MIME du système : *à vérifier*.
