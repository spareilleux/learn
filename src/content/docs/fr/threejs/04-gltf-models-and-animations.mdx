...
<iframe src="../../../threejs-demos/04-gltf.html" title="Leçon 4, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Ouvrir en plein écran](../../../threejs-demos/04-gltf.html). **À essayer** : ouvrez-la en plein écran avec l'onglet Réseau des outils de développement : les trois fichiers `.glb` et le décodeur Draco arrivent avec leur taille, les nombres que l'exercice 3 demande de mesurer.
...
L'[expérience 6](../14-guitar-alchemist-lab/#6-le-bois-de-la-touche--textures-ktx2-et-un-bois-procédural) de la leçon 14 compresse une texture de bois de touche en KTX2 : Basis LZ la livre en 145 ko au lieu de 1.2 Mo, et un bois procédural en TSL ne télécharge rien. Les textures de bois générées avec ComfyUI arrivent bientôt ; en attendant, l'expérience utilise une texture écrite par un script.
