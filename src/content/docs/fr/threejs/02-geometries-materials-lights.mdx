...
<iframe src="../../../threejs-demos/02-materials-lights.html" title="Leçon 2, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
...
<iframe src="../../../threejs-demos/02-materials-lights.html?neckshadow=off" title="Leçon 2 avec ?neckshadow=off, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
