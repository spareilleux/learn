...
<iframe src="../../../threejs-demos/02-materials-lights.html" title="Leçon 2, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Ouvrir en plein écran](../../../threejs-demos/02-materials-lights.html). **À essayer** : décochez *neck casts a shadow* pour la scène de l'exercice 3 (`?neckshadow=off`), ou *shadows* pour voir ce qu'apporte la shadow map. La [scène du studio](../../../threejs-demos/demos/studio.html) de la leçon 7 place une guitare entière sous un projecteur aux ombres douces.
...
L'[expérience 8](../14-guitar-alchemist-lab/#8-les-ombres-sous-les-cordes) de la leçon 14 met des ombres sous les cordes d'un manche entier : une shadow map de 4096 coûte à peu près autant qu'une de 1024, un manche immobile peut rendre son ombre une seule fois avec `shadow.autoUpdate = false`, et une texture précalculée supprime même ce rendu.
...
<iframe src="../../../threejs-demos/02-materials-lights.html?neckshadow=off" title="Leçon 2 avec ?neckshadow=off, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Ouvrir en plein écran](../../../threejs-demos/02-materials-lights.html?neckshadow=off)
