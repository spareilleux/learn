...
La leçon 14 mesure deux fois TSL sur les besoins de GA : l'[expérience 2](../14-guitar-alchemist-lab/#2-une-corde-qui-vibre-de-trois-façons) fait vibrer 600 cordes dans le vertex shader, face à des sommets déplacés et à des morph targets, et l'[expérience 4](../14-guitar-alchemist-lab/#4-bracelets-de-classes-de-hauteurs-transposés-sur-le-cpu-ou-en-tsl) transpose 4 096 bracelets de classes de hauteurs en TSL, pour 8 fois moins de temps CPU qu'en JavaScript.
