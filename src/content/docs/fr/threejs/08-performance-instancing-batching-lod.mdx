...
<iframe src="../../../threejs-demos/08-performance.html" title="Leçon 8, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
...
<iframe src="../../../threejs-demos/08-performance.html?mode=lod&view=close" title="Leçon 8 avec ?mode=lod&view=close, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
