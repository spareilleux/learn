...
<iframe src="../../../threejs-demos/08-performance.html" title="Leçon 8, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Ouvrir en plein écran](../../../threejs-demos/08-performance.html). **À essayer** : *mode* passe d'une des six versions mesurées plus bas à l'autre, *markers* change leur nombre, et *view* rapproche la caméra : *tiles* avec *close* est la mesure de l'exercice 1. La [scène des voicings](../../../threejs-demos/demos/voicing.html) de la leçon 13 dessine les marqueurs d'un accord avec une seule `InstancedMesh` : 7 draw calls, quel que soit l'accord.
...
<iframe src="../../../threejs-demos/08-performance.html?mode=lod&view=close" title="Leçon 8 avec ?mode=lod&view=close, en direct" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Ouvrir en plein écran](../../../threejs-demos/08-performance.html?mode=lod&view=close)
...
La leçon 14 applique les comptes de cette leçon aux scènes de GA : l'[expérience 1](../14-guitar-alchemist-lab/#1-le-manche-de-quatre-façons) dessine 16 manches de quatre façons (72 draw calls par manche dans la structure de GA, 4 fusionnés, et `BatchedMesh` à un appel par objet sur WebGPU), l'[expérience 10](../14-guitar-alchemist-lab/#10-un-mur-de-guitares--lod-et-culling) montre que `LOD` économise du temps GPU mais coûte du temps CPU pour un mur de guitares, et l'[expérience 5](../14-guitar-alchemist-lab/#5-le-nuage-de-voicings-optic-k-jusquà-1000000-de-points) dessine les 313 047 voicings de GA en un seul draw call de points.
