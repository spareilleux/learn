...
Sur un bracelet, T*n* fait tourner le polygone et I0 le reflète par rapport à la droite qui passe par 0 et 6 : 4 va sur 8 et 7 sur 5, tandis que 0 reste en place. Sur ses pages, Ian Ring marque ces droites sur les bracelets en pointillés, comme « axes de symétrie par réflexion » ([gamme 2741](https://ianring.com/musictheory/scales/2741)).

<BraceletInversion role="img" aria-label="Bracelet avec deux triangles symétriques par rapport à un axe en tirets passant par 0 et 6 : la triade de C majeur 0 4 7 et son inversion I0, la triade de F mineur 0 5 8. La classe de hauteurs 0 appartient aux deux." />
...
Les deux bracelets rendent la différence visible : aucune rotation ni image miroir ne transforme une forme en l'autre, et pourtant chacune contient exactement une paire de notes à un demi-ton, une à un ton, et ainsi de suite jusqu'à un triton.

<BraceletZ role="img" aria-label="Deux bracelets. 4-Z15 : 0 1 4 6. 4-Z29 : 0 1 3 7. Des formes différentes au même vecteur d'intervalles 111111." />
