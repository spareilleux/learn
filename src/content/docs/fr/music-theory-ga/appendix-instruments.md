...
- **Un bout de nom resté dans les hauteurs.** `Dulcimer.LydianMode`, c'est `Bb C4 C4 F3 Bb2`. Le premier `Bb` ressemble à une hauteur sans octave, mais [`Tunings.txt`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Business.Config/Tunings.txt#L112), le fichier dont vient le YAML, donne `Ducimer - Lydian Mode Bb C4 C4 F3 Bb2` : le `Bb` termine le nom de l'accordage, *Lydian Mode Bb*.
