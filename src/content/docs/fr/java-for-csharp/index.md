...
| 12 | [La bibliothèque standard du quotidien](12-standard-library/) | `DateTime`, `decimal`, `HttpClient`, `System.IO` |
| 13 | La JVM à l'exécution *(à venir)* | le CLR, réglages du GC, `dotnet-counters`, Native AOT |
