...
Code: [`examples/l01_hello.js`](https://github.com/spareilleux/learn/blob/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/examples/l01_hello.js), the projects [`l01-esm`](https://github.com/spareilleux/learn/tree/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/l01-esm), [`l01-cjs`](https://github.com/spareilleux/learn/tree/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/l01-cjs) and [`l01-interop`](https://github.com/spareilleux/learn/tree/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/l01-interop), and the error snippets in [`errors/`](https://github.com/spareilleux/learn/tree/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/errors).
...
The `scripts` of `package.json` are named commands, the closest thing to MSBuild targets or Maven goals. [`l01-esm/package.json`](https://github.com/spareilleux/learn/blob/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/l01-esm/package.json) has two:
...
This site's [`package.json`](https://github.com/spareilleux/learn/blob/c13a07e40b30f8ce81fc25cd373b821b569e6c60/package.json#L1-L12) declares `"type": "module"` and scripts that call [Astro](https://docs.astro.build/): `npm run build` runs `astro build`, found in `node_modules/.bin`.
...
The third case works, with a warning. [`l01-interop/package.json`](https://github.com/spareilleux/learn/blob/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/l01-interop/package.json) has no `"type"`, and `detect.js` contains an `import`:
...
`require` in an ES module. The course folder's [`package.json`](https://github.com/spareilleux/learn/blob/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/package.json) says `"type": "module"`:
...
- Node.js 24 is the LTS line until October 2026, supported until April 2028; npm comes with it.
...
Only the path: `require('./greet')` doesn't find `greet.mjs`, because `require` only tries the extensions `.js`, `.json` and `.node`. [`solutions/l01-ex1`](https://github.com/spareilleux/learn/tree/c13a07e40b30f8ce81fc25cd373b821b569e6c60/code/javascript-for-csharp-java/solutions/l01-ex1):
