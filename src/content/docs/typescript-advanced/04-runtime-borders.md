...
- [esbuild API](https://esbuild.github.io/api/), and the npm download counts from [api.npmjs.org](https://github.com/npm/registry/blob/main/docs/download-counts.md)
