...
El [experimento 11](../14-guitar-alchemist-lab/#11-rapier-una-púa-que-golpea-una-cuerda) de la lección 14 golpea una cuerda con una púa: el CCD no impidió que una púa cinemática la atravesara, y una cadena de articulaciones se estiró una cuarta parte a 240 pasos por segundo. Una cuerda que se pueda tocar se modela mejor con una ecuación de resorte, y Rapier solo detecta el golpe.
