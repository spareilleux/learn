...
<iframe src="../../../threejs-demos/07-post.html" title="Lección 7, en vivo" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
...
<iframe src="../../../threejs-demos/demos/studio.html" title="Una guitarra en un estudio" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
