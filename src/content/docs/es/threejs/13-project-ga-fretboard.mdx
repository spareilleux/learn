...
<iframe src="../../../threejs-demos/13-fretboard.html?version=ga" title="Lección 13, en vivo" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
...
<iframe src="../../../threejs-demos/13-fretboard.html" title="Lección 13, el port, en vivo" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
...
<iframe src="../../../threejs-demos/demos/voicing.html" title="Voicings de acordes en el diapasón" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
