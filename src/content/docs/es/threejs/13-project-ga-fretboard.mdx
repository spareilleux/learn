...
<iframe src="../../../threejs-demos/13-fretboard.html?version=ga" title="Lección 13, en vivo" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Abrir a pantalla completa](../../../threejs-demos/13-fretboard.html?version=ga). **Pruébalo**: *version* cambia entre la estructura de GA y el port. Solo la sonda coloca los marcadores del acorde; la [demo en vivo](#demo-en-vivo-voicings-de-acordes) al final de la lección los coloca desde un panel.
...
<iframe src="../../../threejs-demos/13-fretboard.html" title="Lección 13, el port, en vivo" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Abrir a pantalla completa](../../../threejs-demos/13-fretboard.html)
...
## Demo en vivo: voicings de acordes

El port en uso: el panel elige uno de 14 acordes y uno de sus voicings, de las formas abiertas a las formas de mi y de la más arriba en el mástil, y cada marcador toma el color de su función, fundamental, tercera, quinta o séptima. Los voicings se escribieron a mano, y la sonda los comprueba nota por nota: do con forma de mi en el traste 8 da C3 G3 C4 E4 G4 C5, y Bm7♭5 en el traste 2 da x B2 F3 A3 D4 x. Cada cambio de acorde construye los marcadores una vez (`markerBuilds` pasa a 1, 2, 3) y mantiene 7 draw calls. El [código](https://github.com/spareilleux/learn/tree/f68e710/code/threejs/demos/voicing) está en `code/threejs/demos/voicing`.

![Un diapasón largo y oscuro con trastes numerados, visto desde arriba y en ángulo, con cuatro marcadores de color cerca de la cejuela, rojo, amarillo, azul y verde, y una leyenda abajo a la izquierda que dice Bm7♭5, fret 2: x B2 F3 A3 D4 x (low E to high E), y luego root, third, fifth y seventh con sus colores.](../../../../assets/threejs/demo-voicing.webp)

<details>
<summary>Página en vivo: ejecutarla aquí</summary>

<iframe src="../../../threejs-demos/demos/voicing.html" title="Voicings de acordes en el diapasón" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Abrir a pantalla completa](../../../threejs-demos/demos/voicing.html). **Pruébalo**: elige un acorde y un voicing, haz clic en una posición para oírla, o *strum*. Antes del ejercicio 2, cuenta aquí los marcadores de un acorde de do mayor y predice los draw calls de la escala.

## Experimento GA

La lección 14 continúa este proyecto: el [experimento 1](../14-guitar-alchemist-lab/#1-el-mástil-de-cuatro-maneras) mide el port de esta lección frente a la estructura de GA en 16 mástiles, donde la de GA tarda 8 veces el tiempo de CPU de mástiles fusionados, y el [experimento 13](../14-guitar-alchemist-lab/#13-webaudio-y-la-vibración-de-la-cuerda) sincroniza la vibración de una cuerda con su sonido, que empieza unos 30 ms tarde sin compensación.
