...
- **Parte de un nombre en las alturas.** `Dulcimer.LydianMode` es `Bb C4 C4 F3 Bb2`. El primer `Bb` parece una altura sin octava, pero [`Tunings.txt`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Business.Config/Tunings.txt#L112), el archivo del que viene el YAML, dice `Ducimer - Lydian Mode Bb C4 C4 F3 Bb2`: el `Bb` termina el nombre de la afinación, *Lydian Mode Bb*.
