...
El curso de ComfyUI dibuja los mismos voicings como imágenes: su [lección 11](../../comfyui/11-custom-nodes-and-security/) escribe nodos de GA que convierten `x32010` en un diagrama de acorde y en un mapa del mástil para generar imágenes, con el orden de cuerdas de los diagramas y el de GA uno junto al otro.
