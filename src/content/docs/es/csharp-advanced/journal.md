...
Este curso perfila [GuitarAlchemist/ga](https://github.com/GuitarAlchemist/ga), un repositorio público, y corre sobre .NET 10 y BenchmarkDotNet: todo lo que sigue es código de otros, incluso donde el autor de GA y el del curso son la misma persona. Tres filas subieron aguas arriba como pull requests y se fusionaron; las demás nunca se reportaron, y la columna Estado dice cuál es cuál.

| Esperado | Lo que pasa | Dónde | Medición | Estado |
|---|---|---|---|---|
| Reconocer un acorde para cada voicing cuesta lo que cuesta un reconocimiento | 667 125 voicings usan solo unos 2500 conjuntos de clases de altura distintos, así que la búsqueda de patrón de cada conjunto se repetía unas 266 veces | `CanonicalChordRecognizer.IdentifyChordSet` | `dotnet-trace` situaba allí cerca del 52 % del hilo principal, en su mayoría construyendo `HashSet`. Con una caché de 4096 casillas, `VoicingAnalyzer.Analyze` pasó de 234,34 ms y 759 MB a 8,94 ms y 22 MB | Corregido aguas arriba, [PR #695](https://github.com/GuitarAlchemist/ga/pull/695) [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests) |
| El vector de clases de intervalo se calcula una vez por conjunto | Se recalculaba en cada llamada | la teoría atonal de GA | El mismo camino de análisis; el volcado de los 8192 vectores es idéntico byte a byte antes y después | Corregido aguas arriba, [PR #694](https://github.com/GuitarAlchemist/ga/pull/694) [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests) |
| `OptickIndexReader.Dimension` se lee una vez | Se leía en cada consulta, mediante una propiedad que lanza un `Where` + `Sum` de LINQ sobre el registro de particiones | `OptickIndexReader.Dimension` | Los 38 MB por consulta atribuidos a la búsqueda se asignaban ahí, no en `Parallel.For`: un barrido secuencial asignaba los mismos 38 MB | Corregido aguas arriba, [PR #693](https://github.com/GuitarAlchemist/ga/pull/693) [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests) |
| La exportación del índice OPTIC-K es reproducible desde un commit | La primera exportación de la noche difiere de las siguientes en 266 de 313 047 entradas, con el mismo commit de GA | exportación OPTIC-K | 266 entradas de 313 047, identificadas por instrumento y diagrama | Corregido upstream por [#730](https://github.com/GuitarAlchemist/ga/pull/730), fusionada el 2026-09-24. La causa era el generador paralelo de voicings, cuyo orden de salida seguía la planificación de los hilos; dos exportaciones de guitarra del main de GA tenían hashes distintos antes, idénticos después [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| El camino paralelo de `VoicingGenerator` es más rápido que el secuencial | Era el doble de lento: un solo consumidor construía todos los diagramas y descartaba los duplicados | [`VoicingGenerator.cs`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Domain.Services/Fretboard/Voicings/Generation/VoicingGenerator.cs#L180-L249) | 1.419 ms frente a 711 ms para 667.125 voicings | Corregido upstream por [#730](https://github.com/GuitarAlchemist/ga/pull/730): los productores hacen ese trabajo, 649-679 ms frente a 786-861 ms en secuencial, medido para la PR; no vuelto a medir en este curso [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| `PitchClassSet.GetCompatibleKeys` es lo bastante barato para llamarlo por voicing | Reconstruía las 30 tonalidades y sus conjuntos de clases de altura en cada llamada | [`PitchClassSet.cs`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Domain.Core/Theory/Atonal/PitchClassSet.cs#L592-L595) | 13,5 % del perfil del análisis; 180,5 ms y 110.116 bytes por llamada en 4.096 llamadas | Corregido upstream por [#730](https://github.com/GuitarAlchemist/ga/pull/730): una prueba de inclusión sobre máscaras de 12 bits, calculada una vez por conjunto, 0,1 ms y 0 bytes; no vuelto a medir en este curso [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| `ValueObjectUtils<TSelf>.Items` devuelve la colección que guarda | Crea una `ValueObjectCollection<TSelf>` nueva de 32 bytes en cada llamada | [`ValueObjectUtils.cs`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Core/ValueObjects/ValueObjectUtils.cs#L10) | 32 bytes por llamada | Corregido upstream por [#730](https://github.com/GuitarAlchemist/ga/pull/730): una sola colección inmutable, 0 bytes por lectura [2026-09-16](#2026-09-16--dogfooding-las-interfaces-de-objetos-de-valor-de-ga), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| `IRangeValueObject<TSelf>.EnsureValueInRange` normaliza sobre el rango real | Normaliza con un tamaño de rango desviado en uno | [`IRangeValueObject.cs`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Core/Abstractions/IRangeValueObject.cs#L55-L63) | Valor equivocado en el límite | Corregido upstream en [#598](https://github.com/GuitarAlchemist/ga/pull/598), fusionada el 2026-09-24, sin prueba; [#731](https://github.com/GuitarAlchemist/ga/pull/731) añade una, que falla con el código antiguo [2026-09-16](#2026-09-16--dogfooding-las-interfaces-de-objetos-de-valor-de-ga), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| `default(Str)` da un objeto de valor válido | Da la cuerda 0, que la propia comprobación de rango de `Str` prohíbe — igual que `new Str[n]` y `new T()` en un método genérico | todo objeto de valor de GA cuyo mínimo es 1 | La lección 5 muestra las tres puertas | Reproducido, límite del patrón más que defecto [2026-09-16](#2026-09-16--dogfooding-las-interfaces-de-objetos-de-valor-de-ga) |
| El `out` de `IStaticReadonlyCollection<out TSelf>` aporta varianza | No aporta nada: 13 de sus 17 implementaciones son structs, y la interfaz no tiene miembros de instancia | `IStaticReadonlyCollection<out TSelf>` | 13 de 17 | Reproducido, inocuo [2026-09-16](#2026-09-16--dogfooding-las-interfaces-de-objetos-de-valor-de-ga) |
| `ValueObjectCache<T>` construye lo que sus llamadores usan | Construye en su primer uso dos `FrozenSet` que nadie lee | [`ValueObjectCache.cs`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Core/ValueObjects/ValueObjectCache.cs#L38-L52) | Dos conjuntos construidos, cero lectores | Corregido upstream por [#730](https://github.com/GuitarAlchemist/ga/pull/730): los dos conjuntos se construyen en el primer uso [2026-09-16](#2026-09-16--dogfooding-las-interfaces-de-objetos-de-valor-de-ga), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| El calentamiento de un benchmark mide lo que miden sus iteraciones | El mismo código midió 31 ns en el calentamiento y de 41 a 52 ns en las iteraciones | BenchmarkDotNet, `VoicingWithSpans` | Fijado a un núcleo con `--affinity` mide 32,4 ns, en el primer núcleo igual que en el último: los núcleos del Core Ultra 9 285K no son iguales | Entendido, y por eso la lección fija el núcleo [2026-09-14](#2026-09-14--benchmarks) |
| Añadir `[MemoryDiagnoser]` a una serie en marcha añade su columna | Sin recompilar, la serie usó el build anterior y no imprimió ninguna columna `Allocated`, sin avisar | BenchmarkDotNet | Sin columna, sin aviso | Reproducido, un error del usuario que la herramienta vuelve invisible [2026-09-14](#2026-09-14--benchmarks) |
| El PGO dinámico elimina la asignación del enumerador como en la lección 4 | No: la primera versión con máscaras seguía asignando 72 bytes por llamada, de enumeradores obtenidos por `IEnumerable<int>` | PGO dinámico de .NET 10 | Pasar a `int[]` y `HashSet<int>` quitó los 72 bytes y lo hizo 2,7 veces más rápido todavía | Reproducido; por qué el caso de la lección 4 se desvirtualiza y este no sigue abierto [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests) |
| `PitchClassSetId.ItemsSpan` devuelve una vista de los ids | Copiaba los 4.096 ids en un array nuevo en cada llamada: `Items` es una lista de solo lectura generada por el compilador, así que la prueba `is PitchClassSetId[]` siempre era falsa | [`PitchClassSetId.cs#L59-L71`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Domain.Core/Theory/Atonal/PitchClassSetId.cs#L59-L71) | 16.408 bytes por llamada | Corregido upstream por [#687](https://github.com/GuitarAlchemist/ga/pull/687), fusionada el 2026-09-20; no se volvió a medir [2026-09-14](#2026-09-14--dogfooding-lo-que-las-lecciones-encontraron-en-ga), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| El operador `-` de `PitchClass` cuesta más o menos lo que cuesta `(a - b + 12) % 12` | Buscaba el resultado en un `FrozenDictionary` de 144 tuplas | [`PitchClass.cs#L110-L137`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Domain.Core/Theory/Atonal/PitchClass.cs#L110-L137) | 583 ns para los 144 pares, frente a 134 ns para la aritmética y 41,5 ns para un array plano | Corregido upstream por [#687](https://github.com/GuitarAlchemist/ga/pull/687) con una tabla plana de 144 entradas; no se volvió a medir [2026-09-14](#2026-09-14--dogfooding-lo-que-las-lecciones-encontraron-en-ga), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| Se puede bloquear sobre `Try.OfAsync`, y cancelarlo | Esperaba sin `ConfigureAwait(false)`, así que bloquear sobre él bajo un contexto de sincronización de un solo hilo producía un interbloqueo, y convertía `OperationCanceledException` en un fallo corriente | [`Try.cs#L62-L73`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Core/Functional/Try.cs#L62-L73) | Mostrado en la lección 3 | Corregido upstream por [#687](https://github.com/GuitarAlchemist/ga/pull/687) [2026-09-14](#2026-09-14--dogfooding-lo-que-las-lecciones-encontraron-en-ga), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |
| `LazyWithExpiration<T>` no cuesta nada mientras espera | Ocupaba un hilo del pool en `Thread.Sleep` por valor | [`LazyWithExpiration.cs#L20-L40`](https://github.com/GuitarAlchemist/ga/blob/a826864f3a012cad88e415954bf57eca0ce12aa6/Common/GA.Core/Utilities/LazyWithExpiration.cs#L20-L40) | 64 valores que expiraban tras un segundo retrasaban un `Task.Run` ajeno 2 s en mi máquina y de 10 a 12 s en los runners de 3 y 4 núcleos | Corregido upstream por [#687](https://github.com/GuitarAlchemist/ga/pull/687): la expiración es una marca de tiempo comprobada en cada acceso [2026-09-14](#2026-09-14--dogfooding-lo-que-las-lecciones-encontraron-en-ga), [2026-09-24](#2026-09-24--correcciones-upstream-comprobadas-de-nuevo) |

## Experimentos

El trabajo de rendimiento invita a leer una predicción dentro de su propio resultado, así que estas filas conservan la hipótesis tal como se escribió y la dejan equivocarse. Dos de las seis están refutadas, y el método del apéndice — comparar dos builds de GA en lugar de dos métodos, y comprobar que cada respuesta es idéntica byte a byte — es él mismo la tercera fila.

| Pregunta | Hipótesis | Resultado | Veredicto | Dónde |
|---|---|---|---|---|
| ¿Es `FrozenDictionary` más rápido que `Dictionary` con doce sufijos de acorde cortos? | Escrita de antemano: sí, para eso está | No lo era | Refutada | [2026-09-14](#2026-09-14--benchmarks) |
| ¿Es `SearchValues` más rápido que un bucle sobre símbolos de acorde de 1 a 6 caracteres? | Escrita de antemano: sí | 1,7 veces más lento | Refutada | [2026-09-14](#2026-09-14--benchmarks) |
| ¿Da un build con los cambios de análisis respuestas idénticas byte a byte a `main`? | Escrita de antemano, y es el método entero: la demostración compara dos builds de GA, no dos métodos | Idénticas en los cinco volcados: `TryMatch` 258 048 líneas, reconocimiento 106 496, vectores de clases de intervalo 8192, los 667 125 voicings, 2048 búsquedas sobre el índice real de 313 047 entradas | Confirmada | [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests) |
| ¿Venían de `Parallel.For` los 38 MB por consulta de la búsqueda? | Escrita de antemano: el paralelismo era el sospechoso | Un barrido secuencial asignó los mismos 38 MB, lo que absolvió a `Parallel.For` y señaló a `GetVector` | Refutada | [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests) |
| ¿Sobrevive el particionado por rangos de la búsqueda al arreglo de asignaciones? | No escrita como predicción: medía un 8 % más rápido antes del arreglo, así que parecía digno de conservar | Un 22 % más lento después. Descartado | Refutada | [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests) |
| ¿Se acelera la exportación OPTIC-K entera de punta a punta, y no solo el benchmark? | Escrita de antemano: el análisis es la mayor parte de la exportación | Cuatro ejecuciones alternando `main` y el build modificado: 142,8 s frente a 62,9 s, luego 95,0 s frente a 38,3 s. El mismo binario de `main` tardó 142,8 s y luego 95,0 s: la máquina no estaba ociosa, y son los pares, no los tiempos absolutos, el resultado | Confirmada | [2026-09-17](#2026-09-17--apéndice-2-perfilar-ga-con-pull-requests) |
...
- Los cuatro hallazgos de las lecciones 1 a 4 se corrigieron upstream en [#687](https://github.com/GuitarAlchemist/ga/pull/687), fusionada el 2026-09-20, cada uno con un test que falla con el código antiguo: `ItemsSpan` devuelve su array subyacente, el `-` de `PitchClass` lee una tabla plana de 144 entradas (unos 42 ns en el benchmark de este curso, según la PR), `Try.OfAsync` usa `ConfigureAwait(false)` y deja pasar la cancelación, y `LazyWithExpiration<T>` comprueba una marca de tiempo en cada acceso. Comprobado en el código en GA [`27a1257`](https://github.com/GuitarAlchemist/ga/commit/27a1257f7fe5478c4b1bcb6b86ebe101707ac935). El curso sigue fijado a `a826864`, así que sus benchmarks siguen midiendo el código antiguo; no los he ejecutado contra la corrección (*por verificar*).
- La PR señala un cambio de comportamiento: `MonadicServiceBase`, en GaApi y GA.MusicTheory.Service, deja pasar ahora la cancelación de una petición en lugar de devolver un `Try` fallido.
- Estos cuatro hallazgos solo figuraban en la entrada del 2026-09-14; ahora tienen sus filas en la tabla QA.
- [#730](https://github.com/GuitarAlchemist/ga/pull/730), fusionada el 2026-09-24, corrige los hallazgos de rendimiento aún abiertos, y la exportación que no era reproducible. Medido para la PR en una máquina, en Release, 4.096 llamadas por miembro tras un calentamiento; no he vuelto a ejecutar los benchmarks de este curso contra ella (*por verificar*):
  - `PitchClassSet.ClosestDiatonicKey`: 308,7 ms y 175.699 bytes por llamada antes, 1,0 ms y 0 bytes después; `GetCompatibleKeys`: 180,5 ms y 110.116 bytes, luego 0,1 ms y 0 bytes; `ToNormalForm` e `IsNormalForm` leen una tabla de 4.096 entradas. Una prueba compara cada uno con la implementación antigua, conservada como oráculo, en los 4.096 conjuntos, desempates incluidos.
  - `ValueObjectUtils<TSelf>.Items` devuelve una sola colección, y `Values`, leído a través de `IReadOnlyList<int>`, ya no empaqueta 24 bytes por lectura en nueve tipos.
  - El camino paralelo de `VoicingGenerator` emite ahora sus ventanas en orden de trastes, así que su flujo es el secuencial. Ese orden era la causa de la diferencia entre exportaciones: la exportación conserva el primero de los voicings igual de baratos. Dos exportaciones de guitarra del main de GA tenían los hashes `776c849e…` y `d0a7d1d9…`; con la corrección, `138603e8…` las dos veces.
- `EnsureValueInRange` se corrigió dentro de [#598](https://github.com/GuitarAlchemist/ga/pull/598), una PR de funcionalidades, sin prueba. [#731](https://github.com/GuitarAlchemist/ga/pull/731) añade una: 9 pruebas pasan en main, y 5 de ellas fallan con el archivo de `a826864`.
