...
- [#734](https://github.com/GuitarAlchemist/ga/pull/734), fusionada el 2026-09-24, corrige `GetNormalForm`: los empates de amplitud se resuelven como lo hace Rahn, por los intervalos del primer elemento al penúltimo, luego al antepenúltimo, y así sucesivamente. `{0, 4, 7, 8}` da ahora `[0; 3; 4; 8]`, igual que su transposición por 8. Su prueba pasa los 4.096 conjuntos por T1 a T11; con el código antiguo, 5.920 de esas 45.045 transposiciones cambiaban la respuesta. El comentario de documentación ya no llama al resultado una forma prima de Forte: es el orden normal transpuesto a cero, sin la inversión. Una última prueba fija `{0, 1, 5, 6, 8}`, un conjunto en el que Rahn y Forte no coinciden.
