...
Si incumples la regla, el programa **entra en pánico** ([`src/lib.rs`, líneas 761-764](https://github.com/spareilleux/learn/blob/93f6f82/code/rust-for-csharp-java/src/lib.rs#L761-L764), [`core/src/cell.rs`](https://github.com/rust-lang/rust/blob/1.94.0/library/core/src/cell.rs#L885-L895)):
