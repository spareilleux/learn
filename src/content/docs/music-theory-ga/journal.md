...
- [`recheck/probe.cs`](https://github.com/spareilleux/learn/blob/main/code/music-theory-ga/recheck/probe.cs) calls the same tool methods directly, without the MCP transport, on GA [`27a1257`](https://github.com/GuitarAlchemist/ga/commit/27a1257f7fe5478c4b1bcb6b86ebe101707ac935); its output is [`recheck/results.txt`](https://github.com/spareilleux/learn/blob/main/code/music-theory-ga/recheck/results.txt). It is not part of `check.sh`, because it needs a full GA clone.
