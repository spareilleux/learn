...
- Most real actions use the [`@actions/core`](https://github.com/actions/toolkit/tree/193fa46c20fde8b0ed54194bc08b841c78c0776d/packages/core) package for this (`core.getInput`, `core.setOutput`, `core.setFailed`), and then must commit `node_modules` or a bundled `dist/index.js`: the runner doesn't run `npm install`. Without dependencies, there's nothing to bundle.
