...
<iframe src="../../threejs-demos/13-fretboard.html?version=ga" title="Lesson 13, live" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>
...
<iframe src="../../threejs-demos/13-fretboard.html" title="Lesson 13, the port, live" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>
...
<iframe src="../../threejs-demos/demos/voicing.html" title="Chord voicings on the fretboard" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>
...
Lesson 14 continues this project: [experiment 1](../14-guitar-alchemist-lab/#1-the-neck-four-ways) measures this lesson's port against GA's structure on 16 necks, where GA's takes 8 times the CPU of merged necks, and [experiment 13](../14-guitar-alchemist-lab/#13-webaudio-and-the-strings-vibration) syncs a string's vibration with its sound, which starts about 30 ms late without compensation.
