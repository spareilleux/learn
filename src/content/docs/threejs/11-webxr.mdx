...
<iframe src="../../threejs-demos/demos/xr.html?emulate" title="The guitar in VR" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
