...
<iframe src="../../threejs-demos/03-color.html?tone=aces" title="Lesson 3, tone mapping, live" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
...
<iframe src="../../threejs-demos/03-environment.html" title="Lesson 3, HDR environment, live" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block" }}></iframe>
