...
<iframe src="../../threejs-demos/03-color.html?tone=aces" title="Lesson 3, tone mapping, live" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Open full screen](../../threejs-demos/03-color.html?tone=aces). **Try it**: pick *agx* in *tone mapping*, then set *exposure* to 2 and to 4: the two runs of exercise 3.
...
<iframe src="../../threejs-demos/03-environment.html" title="Lesson 3, HDR environment, live" loading="lazy" width="100%" height="420" allow="fullscreen; autoplay; xr-spatial-tracking" style={{ border: 0, display: "block", height: "min(420px, 70vh)" }}></iframe>

</details>

[Open full screen](../../threejs-demos/03-environment.html). **Try it**: the [studio scene](../../threejs-demos/demos/studio.html) of lesson 7 lights a whole guitar with the same `studio.hdr`, and its panel changes `environmentIntensity` and the exposure.
...
Lesson 14's [experiment 7](../14-guitar-alchemist-lab/#7-a-pbr-grid-for-strings-and-frets) lights a grid of metal and plastic spheres, as for strings and frets: different metalness and roughness values don't add shader programs, since they are uniforms, and physical materials cost shading time, not compilation.
